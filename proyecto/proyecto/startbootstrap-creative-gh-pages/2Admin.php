...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background-color:orange;">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a style="color:white;" class="navbar-brand page-scroll" href="#page-top">AutoGol-Administrador
                </a>
...
<div class="module form-module">
  ...
  <div class="form">
    <h2>Inicio Sesion</h2>
      ...
      <input type="text" name="usuer" placeholder="Administrador"/>
      <input type="password" name="pass" placeholder="Contraseña"/>
      <button >
        <a id="#prop" href="\proyecto\proyecto\Administrador\index.php" style="color:white; ">Iniciar Sesion</a></button>
        <br/>
        <br/>
        <button >
