...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background-color:orange;">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="http://localhost/proyecto/proyecto/startbootstrap-creative-gh-pages/user.php">Volver</a>
                    </li>
...
<table style="position:relative; left:120px;  ">
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr style="position:relative; left:-150px; border-spacing:15px; margin:auto">
			<img style="width:100px;" src="\proyecto\proyecto\startbootstrap-creative-gh-pages\usuario\img/<?php echo $row['campo3']; ?>"></a>
            <br/>
            <br/>
            Numero de documento: <?php echo $row['name']; ?>
            <br/>
            <br/>
			Nombre: <?php echo $row['address']; ?>
            <br>
            <br>
			Apellidos: <?php echo $row['campo1']; ?>
            <br/>
            <br/>
           Sexo: <?php echo $row['campo2']; ?>
           <br/>
           <br/>
          Usuario: <?php echo $row['campo4']; ?>
           <br/>
           <br/>
		Contraseña: <?php echo $row['campo5']; ?>
            
            <td>
            <br/>
            <br/>
            <br/>
                <a style="background-color:orange; color:white; border-color:orange;" href="6IngProduct.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Editar perfil</a><br><br>
            
                <a style="background-color:orange; color:white; border-color:orange;"  href="server.php?del=<?php echo $row['id']; ?>" class="del_btn">Eliminar cuenta</a>
            </td>
