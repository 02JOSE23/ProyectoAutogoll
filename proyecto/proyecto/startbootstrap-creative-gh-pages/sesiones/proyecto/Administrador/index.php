        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="font-size:10px;">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/6IngProduct.php">Ingreso De Productos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/7VenProduct.php">Venta de productos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/8Cuanto.php">Alquiler De Canchas</a>
                    </li>
                       <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\9Persona.php">Ingreso de personal</a>

                    </li>  <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\inventario.php">Inventario</a>

                    </li>
                    <li>
                        <a class="page-scroll"  href="\proyecto\proyecto\startbootstrap-creative-gh-pages\1Usuario.php">Cerrar Sesion</a>
