...
if (empty($_SESSION['id'])){
    header("Location: ../Vista/Vista/1Usuario.php");
}else
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="font-size:10px;">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/6IngProduct.php">Ver Ingreso De Productos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/7VenProduct.php"> Ver Ventas</a>
                    </li>  <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/8Cuanto.php"> Ver Alquileres</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/4Propietario.php">Ver personal</a>
                    </li>
                     <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/9Persona.php">Ver pago de personal</a>

                    </li>  <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages/info.html">Informe total</a>

                    </li> 
                    <li>
                        <a class="page-scroll"  href="../Vista/Controlador/usuarios_controller.php?action=CerrarSession">Cerrar Sesion</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <p class="intro-text">Km 0 Via Sogamoso - Tibasosa Tels:7736770 - 3182618865</p>
