...
<link rel='stylesheet prefetch' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'>
      ...
      <link rel="stylesheet" href="../../startbootstrap-creative-gh-pages/css/style.css">
...
<div class="module form-module">
  ...
  <div class="form">
    <h2>Inicio Sesion</h2>
    <form name="frmLogin"">
        <input id="User" name="User" type="User" placeholder="Usuario"/>
        <br/>
        ...
        <br/>
        <button>
        <a id="#prop" href="3Crear.php" style="color:white; ">Volver</a>
        </button>
