...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background-color:orange;">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\canchas\6IngProduct.php">Volver</a>
                    </li>
                ...
                <script>
                    ...
                    function tableData(){
                        $('#mytable').Tabledit({
                            ...
                            columns: {
                                identifier: [0, 'id'],
                                editable: [[1, 'name'],[2, 'address', '{"1": "Activar", "2": "Desactivar"}'],[3, 'campo1']]
                            },
