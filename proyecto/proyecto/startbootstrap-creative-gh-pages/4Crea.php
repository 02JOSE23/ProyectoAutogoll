...
<br/>
  ...
  <h1>Tipo De Encargado</h1><!--span>Pen <i class='fa fa-paint-brush'></i> + <i class='fa fa-code'></i> by <a href='http://andytran.me'>Andy Tran</a></span>
</div-->
<!-- Form Module-->
...
<div class="module form-module">
  ...
  <div class="form">
    ...
    <form>
        <button >
        <a id="#prop" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/inventario/6IngProduct.php" style="color:white;">Interno</a></button>
        <br/>
        <br/>
         <button >
        <a id="#prop" href="http://localhost/proyecto/proyecto/startbootstrap-creative-gh-pages/inventario2/6IngProduct.php" style="color:white; ">Externo</a></button>

    </form>
       <br/>
       
 <button >
        <a id="#prop" href="http://localhost/proyecto/proyecto/Administrador/index.php" style="color:white; width:5px;">Volver</a></button>
  </div>
