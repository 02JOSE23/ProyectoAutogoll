...
<html>
<head>
	<title>Inventario AutoGol </title>
...
Buscar: <input  type="text" id="myInput" onkeyup="myFunction()" placeholder="Buscar Nombre del encargado..">
<br>
        ...
        $("#exportButton").click(function () {
            ...
            dataSource.read().then(function (data) {
                ...
                pdf.table(
                    ...
                    data,
                    [
                        { field: "ID", title: "Numero", width: 75 },
                        { field: "Fecha", title: "fecha", width: 75 },
                        { field: "Articulo", title: "articulo", width: 75 },
                        { field: "Cantidad", title: "marca", width: 75 },
                        { field: "Marca", title: "enacrgado", width: 75 },
               
                                 { field: "Cargo", title: "cargo", width: 75 },
    ...
    <script>
        ...
        function tableData(){
            $('#mytable').Tabledit({
                ...
                columns: {
                    identifier: [0, 'id'],
                    editable: [[1, 'name'],[2, 'address'],[3, 'campo1'],[4, 'campo2'],[5, 'campo3'],[6, 'campo4']]
                },
