...
include('server.php');
	if (isset($_GET['edit'])) {
		$id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM inventario WHERE id=$id");
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right">
                 <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="http://localhost/proyecto/proyecto/startbootstrap-creative-gh-pages/inventario/VerIngreso.php">Ver inventario</a>
                    </li>
...
<div style="font-size:14px; width:10px">
	...
	<div >
        ...
        <label id="fl" style="font-size:12px; position: relative; top:10px;">Nombre Del Articulo: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="address" placeholder  ="Nombre del articulo" value="<?php echo $address; ?>">
	</div>
	<div>
	...
	<div>
        ...
        <label id="fl" style="font-size:12px; position: relative; top:10px;">Marca Del Articulo: </label>
        <input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo2" placeholder  ="Marca del articulo" value="<?php echo $campo2; ?>">
    </div><div>

        <label id="fl" style="font-size:12px; position: relative; top:10px;">Nombre Del Encargado: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo3" placeholder  ="Nombre del encargado" value="<?php echo $campo3; ?>">
	</div>
    <div>

        <label id="fl" style="font-size:12px; position: relative; top:10px;">Cargo Del Encargado</label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo4" placeholder  ="Cargo del encargado" value="<?php echo $campo4; ?>">
	</div>
	<div >
	</div>
<br/>
<br/>
		...
		<?php else: ?>
			<button class="btn" type="submit" name="save" style="background-color:orange; color:white; border-color:orange">Ingresar articulo(s)</button>
		<?php endif ?>
		<br/>
		<br/>
...
<?php $results = mysqli_query($db, "SELECT * FROM inventario"); ?>
