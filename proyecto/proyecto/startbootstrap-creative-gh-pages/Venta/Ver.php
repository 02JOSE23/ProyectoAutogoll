                ...
                pdf.table(
                    ...
                    [
                      { field: "ID", title: "id", width: 75},
                        { field: "Fecha", title: "fechas", width: 75 },
                        { field: "Nombre", title: "pructos", width: 85 },
                        { field: "Cantidad", title: "cantidades", width: 75 },
                        { field: "Valor", title: "$pesos", width: 75 },
                        { field: "Total", title: "valor total", width: 75}
                    ],
                    {
                        margins: {
                            top: 50,
