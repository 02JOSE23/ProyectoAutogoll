        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right">
                 <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\Venta\VerIngreso.php">Ver ventas</a>
                    </li>
...
<div style="font-size:14px; width:10px">
	<div>
		...
		<label id="fl" style="font-size:14px; position: relative; top:5px;">Fecha: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px" type="date" name="name" value="<?php echo $name; ?>">
	</div>
	<div >

        <label id="fl" style="font-size:14px; position: relative; top:10px;">Nombre Del Producto: </label>
	...
	<div>
        ...
        <label id="fl" style="font-size:14px; position: relative; top:10px;">Cantidad: </label>
	...
	<div>
        ...
        <label id="fl" style="font-size:14px; position: relative; top:10px;">Valor Por Unidad: </label>
...
<br/>
		...
		<?php else: ?>
			<button class="btn" type="submit" name="save" style="background-color:orange; color:white; border-color:orange">Añadir producto a la factura</button>
		<?php endif ?>
		<br/>
		<br/>
