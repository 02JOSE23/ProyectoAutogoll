        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                 <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="/index.php">Ver inventario</a>
                    </li>
...
<div class="pen-title">
  ...
  <h1>Control de inventario</h1><!--span>Pen <i class='fa fa-paint-brush'></i> + <i class='fa fa-code'></i> by <a href='http://andytran.me'>Andy Tran</a></span>
</div-->
<!-- Form Module-->
...
<div class="module form-module">
  ...
  <div class="form">
    ...
    <br/>
      ...
      <input required="required" type="text" placeholder="Nombre del articulo"/>
      <input required="required" type="number" placeholder="Cantidad"/><input required="required" type="text" placeholder="Marca del articulo"/>
    <input required="required" type="text" placeholder="Nombre del encargado"/>
      <input required="required" type="text" placeholder="Cargo del encargado"/>
     
  <br/>
           <button>Ingresar articulo(s)</button>
           
            <br/>
        <br/>
           <button >
        <a id="#prop" href="\proyecto\proyecto\Administrador\index.php" style="color:white; ">Salir</a></button>
        <br/>
