            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right">
                 <li>
                        ...
                        <a style="color:white;" class="page-scroll" id ="#index" href="http://localhost/proyecto/proyecto/startbootstrap-creative-gh-pages/pago/6IngProduct.php">Pago de personal</a>
                    </li>
...
<div style="font-size:14px; width:10px">
	...
	<div >
		...
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="number" name="address" placeholder  ="Numero de documento" value="<?php echo $address; ?>">
	</div>
	<div>

        <label id="fl" style="font-size:12px; position: relative; top:10px;">Nombre: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo1" placeholder  ="Nombres" value="<?php echo $campo1; ?>">
	</div>
	<div>

        <label id="fl" style="font-size:12px; position: relative; top:10px;">Apellidos: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo2" placeholder  ="Apellidos" value="<?php echo $campo2; ?>">
	</div>
    <div>

		<label id="fl" style="font-size:12px; position: relative; top:10px;">Foto:</label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="file" name="campo3" value="<?php echo $campo3; ?>">
	</div>
    <div>

        <label id="fl" style="font-size:12px; position: relative; top:10px;">Cargo: </label>
		<input required="required" style="width:220px; position: relative; top: -12px; left: 100px;" type="text" name="campo4" placeholder  ="Cargo" value="<?php echo $campo4; ?>">
	</div>
	<div >
	</div>
<br/>
<br/>
		...
		<?php else: ?>
			<button class="btn" type="submit" name="save" style="background-color:orange; color:white; border-color:orange">Ingresar empleado</button>
		<?php endif ?>
		<br/>
		<br/>
