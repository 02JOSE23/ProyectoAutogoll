...
Buscar: <input  type="text" id="myInput" onkeyup="myFunction()" placeholder="Buscar Nombre">
<br>
<br>
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <?php while ($row = mysqli_fetch_array($results)) { ?>
        <tr style="position:relative; left:-150px; border-spacing:15px; margin:auto">
            ...
            <td><img style="width: 50px" src="../img/<?php echo $row['campo3']; ?>"></a></td>
            ...
            dataSource.read().then(function (data) {
                ...
                pdf.table(
                    ...
                    [
                        ...
                        { field: "Numero_de_documento", title: "documento", width: 75 },
                        { field: "Nombres", title: "nombre", width: 75 },
                        { field: "Apellidos", title: "apelido", width: 75 },
                        { field: "Cargo", title: "cargo", width: 75 },
                        
                        { field: "Foto", title: "foto", width: 75 }
                    ],
                    {
                        margins: {
                            top: 50,
    ...
    <script>
        ...
        function tableData(){
            $('#mytable').Tabledit({
                ...
                columns: {
                    identifier: [0, 'id'],
                    editable: [[1, 'name'],[2, 'gender'],[3, 'email'],[4, 'phone'],[5, 'address']]
                },
