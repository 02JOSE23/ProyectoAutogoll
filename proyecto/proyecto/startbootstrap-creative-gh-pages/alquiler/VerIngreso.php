        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a style="color:white;" class="page-scroll" id ="#index" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\alquiler\6IngProduct.php">Volver</a>
                    </li>
...
<script>
    ...
    function tableData(){
        $('#mytable').Tabledit({
            ...
            columns: {
                identifier: [0, 'id'],
                editable: [[1, 'name'],[2, 'address'],[3, 'campo1'],[4, 'campo2'],[5, 'campo3'],[5, 'campo4'],[5, 'total']]
            },
