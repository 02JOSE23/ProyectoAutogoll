        ...
        $("#exportButton").click(function () {
            ...
            dataSource.read().then(function (data) {
                ...
                pdf.table(
                    ...
                    data,
                    [
                        { field: "ID", title: "Numero", width: 35 },
                        { field: "Fecha", title: "fecha", width: 75 },
                        { field: "Cliente", title: "clientes", width: 75 },
                        { field: "Documento", title: "documentos", width: 75 },
                        { field: "Tiempo", title: "tiempo", width: 40 },
                        { field: "Cancha", title: "cancha N^", width: 40 },
                        { field: "Valor", title: "valor", width: 60 },
                        { field: "Total", title: "total", width: 60 }
                    ],
                    {
                        margins: {
                            top: 50,
