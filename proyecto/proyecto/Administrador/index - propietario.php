        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="font-size:10px;">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/Ingrerso/Ver.php">Ver Ingreso De Productos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\Venta\Ver.php"> Ver Ventas</a>
                    </li>  <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\alquiler\Ver.php"> Ver Alquileres</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="\proyecto\proyecto\startbootstrap-creative-gh-pages\personal\Ver.php">Ver personal</a>
                    </li>
                     <li>
                        <a class="page-scroll" href="http://localhost/proyecto/proyecto/startbootstrap-creative-gh-pages/pago/Ver.php">Ver pago de personal</a>

                    </li><li>
                        <a class="page-scroll" href="/proyecto/proyecto/startbootstrap-creative-gh-pages/inventario/Ver.php">Ver Inventario</a>
